import { green } from "https://deno.land/std@0.191.0/fmt/colors.ts";
import type {
    Loader,
    OnLoadArgs,
    OnLoadResult,
    OnResolveArgs,
    Plugin
} from "https://deno.land/x/esbuild@v0.18.1/mod.d.ts";
...
import { fromFileUrl } from "https://deno.land/std@0.191.0/path/mod.ts";
